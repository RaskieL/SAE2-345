...
def admin_commande_show():
    ...
    return render_template('admin/commandes/show.html', commandes=commandes, users=users, articles_commande=articles_commande, commande_adresses=commande_adresses)
