...
def fct_fixtures_load():
    ...
    sql = """DROP TABLE IF EXISTS liste_envie, commentaire, historique, note, ligne_panier, ligne_commande, commande, adresse, utilisateur, declinaison, gant, type_gant, etat, taille, couleur; """
